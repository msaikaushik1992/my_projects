$(function () {
    ...
    var rottenTomotoesMovieLink = "http://api.rottentomatoes.com/api/public/v1.0/lists/dvds/top_rentals.json?apikey=kas6vr9cz8ugnjnpbxxhksgc";
    ...
    function getMovieDataSuccess(data) {
        ...
        $.each(movies, function (i, v) {
            ...
            var div_img = $("<div>").attr('id', id).addClass("img").appendTo("#top").css({
