$(function () {
    ...
    var rottenTomotoesMovieLink = "http://api.rottentomatoes.com/api/public/v1.0/lists/movies/upcoming.json?apikey=kas6vr9cz8ugnjnpbxxhksgc";

    var limit = "&page_limit=25";
